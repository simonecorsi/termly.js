...
var Shell = function (_Interpreter) {
  ...
  _createClass(Shell, [{
    ...
    value: function polyfills() {
      ...
      if (!global.fetch) {
        global.fetch = __webpack_require__(14);
      }
      return true;
    }
...
var File = __webpack_require__(2);
...
var Filesystem = function () {
  ...
  _createClass(Filesystem, [{
    ...
    value: function initFs(fs) {
      ...
      var parsedFs = new File({ name: '/', content: fs, type: 'dir' });
      return parsedFs;
    }
    ...
    value: function fileWalker() {
      ...
      if (node !== '/') {
        var currentNode = fs.content[node];
    ...
    value: function changeDir() {
      ...
      var result = void 0;
      if (path === '..') {
        var prevDir = this.cwd.splice(0, this.cwd.length - 1);
    ...
    value: function listDir() {
      ...
      if (result.node.type === 'file') {
        result.node = _defineProperty({}, result.node.name, result.node);
      }
      return result.node;
    }
...
module.exports = {
  ...
  printenv: {
    ...
    fn: function fn() {
      var env = this.shell.env;
      var res = '';
      Object.keys(env).map(function (key) {
        var value = _typeof(env[key]) === 'object' && !Array.isArray(env[key]) ? JSON.stringify(env[key]) : env[key];
        res += key + '=' + value + '\n';
      });
      return res;
    }
...
var Prompt = function (_Shell) {
  _inherits(Prompt, _Shell);
  ...
  function Prompt() {
    ...
    var _this = _possibleConstructorReturn(this, (Prompt.__proto__ || Object.getPrototypeOf(Prompt)).call(this, options));
